...
public class PTesterDSA extends Applet implements ExtendedLength {
	...
	public static final byte METHOD_ALL = METHOD_SET_DSA_PQG;
	...
	protected PTesterDSA(byte[] buffer, short offset, byte length) {
		register();
	}
	...
	public static void install(byte[] bArray, short bOffset, byte bLength)
		throws ISOException {
		new PTesterDSA(bArray, bOffset, bLength);
	}
}
